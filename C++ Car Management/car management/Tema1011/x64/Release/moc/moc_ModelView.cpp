...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ModelView_t, stringdata0) + ofs), len 
...
const QMetaObject ModelView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ModelView.offsetsAndSize,
    qt_meta_data_ModelView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ModelView_t
