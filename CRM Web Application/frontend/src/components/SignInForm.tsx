        ...
        <div className="">
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            {...field}
                                            className="border-[#C2C7C6] rounded-full border-[1px]"
                                        />
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            {...field}
                                            type="password"
                                            className="border-[#C2C7C6] marker:text-lightblu rounded-full border-[1px]"
                                        />
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                    ...
                    {/*  SUBMIT BUTTON  */}
                    <Button
                        className="bg-[#C51321] w-full rounded-full hover:bg-[#C2C7C6]"
                        type="submit"
                    >
                        Sign in
                    </Button>
